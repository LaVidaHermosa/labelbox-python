    ...
    def _validate_data_rows(cls, objects: List[Dict[str, Any]]):
        ...
        for object in objects:
            ...
            if not is_exactly_one_set(data_row_object.get('id'),
                ...
                if 'annotations' in data_row_object:
                    if 'globalKey' in data_row_object:
                        data_row_id = data_row_object['globalKey']
                    if 'id' in data_row_object:
                        data_row_id = data_row_object['id']
                    annotations = data_row_object['annotations']
                    for annotation in annotations:
                        if 'name' in annotation:
                            labels_per_datarow[data_row_id][
                                annotation['name']] += 1
